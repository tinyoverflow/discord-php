...
/**
 * CreateGuildScheduledEventRequest Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateGuildScheduledEventRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'create_guild_scheduled_event_request';
    ...
    */
    ...
    public function setName(mixed $name): static
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 100)) {
            throw new InvalidArgumentException('invalid length for $name when calling CreateGuildScheduledEventRequest., must be smaller than or equal to 100.');
        }
    ...
    public function setDescription(mixed $description): static
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1000)) {
            throw new InvalidArgumentException('invalid length for $description when calling CreateGuildScheduledEventRequest., must be smaller than or equal to 1000.');
        }
    ...
    public function setChannelId(mixed $channel_id): static
    {
        ...
        if (!is_null($channel_id) && (!preg_match("^(0|[1-9][0-9]*)$", ObjectSerializer::toString($channel_id)))) {
            throw new InvalidArgumentException("invalid value for \$channel_id when calling CreateGuildScheduledEventRequest., must conform to the pattern ^(0|[1-9][0-9]*)$.");
        }
