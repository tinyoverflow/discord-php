...
/**
 * ChannelFollowerWebhookResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ChannelFollowerWebhookResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ChannelFollowerWebhookResponse';
    ...
    */
    ...
    public function setApplicationId(?string $application_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($application_id)))) {
            throw new InvalidArgumentException("invalid value for \$application_id when calling ChannelFollowerWebhookResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setChannelId(?string $channel_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($channel_id)))) {
            throw new InvalidArgumentException("invalid value for \$channel_id when calling ChannelFollowerWebhookResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setGuildId(?string $guild_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($guild_id)))) {
            throw new InvalidArgumentException("invalid value for \$guild_id when calling ChannelFollowerWebhookResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setId(string $id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($id)))) {
            throw new InvalidArgumentException("invalid value for \$id when calling ChannelFollowerWebhookResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setSourceGuild(?\OpenAPI\Client\Model\WebhookSourceGuildResponse $source_guild): static
    {
        if (is_null($source_guild)) {
            array_push($this->openAPINullablesSetToNull, 'source_guild');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('source_guild', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setSourceChannel(?\OpenAPI\Client\Model\WebhookSourceChannelResponse $source_channel): static
    {
        if (is_null($source_channel)) {
            array_push($this->openAPINullablesSetToNull, 'source_channel');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('source_channel', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
