...
/**
 * MessageEditRequestPartial Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MessageEditRequestPartial implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MessageEditRequestPartial';
    ...
    */
    ...
    public function setContent(?string $content): static
    {
        ...
        if (!is_null($content) && (mb_strlen($content) > 4000)) {
            throw new InvalidArgumentException('invalid length for $content when calling MessageEditRequestPartial., must be smaller than or equal to 4000.');
        }
