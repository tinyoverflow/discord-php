...
/**
 * StageInstanceResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class StageInstanceResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'StageInstanceResponse';
    ...
    protected static array $setters = [
        ...
        'id' => 'setId',
        'discoverable_disabled' => 'setDiscoverableDisabled',
    ...
    protected static array $getters = [
        ...
        'id' => 'getId',
        'discoverable_disabled' => 'getDiscoverableDisabled',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('discoverable_disabled', $data ?? [], null);
    ...
    */
    ...
    public function setGuildId(string $guild_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($guild_id)))) {
            throw new InvalidArgumentException("invalid value for \$guild_id when calling StageInstanceResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setChannelId(string $channel_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($channel_id)))) {
            throw new InvalidArgumentException("invalid value for \$channel_id when calling StageInstanceResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
     ...
     * Gets privacy_level
     *
     * @return \OpenAPI\Client\Model\StageInstancesPrivacyLevels
     */
     ...
     * Sets privacy_level
     *
     * @param \OpenAPI\Client\Model\StageInstancesPrivacyLevels $privacy_level privacy_level
     *
     * @return $this
     */
    ...
    public function setId(string $id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($id)))) {
            throw new InvalidArgumentException("invalid value for \$id when calling StageInstanceResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    /**
     * Gets discoverable_disabled
     *
     * @return bool|null
     */
    public function getDiscoverableDisabled(): ?bool
    {
        return $this->container['discoverable_disabled'];
    }

    /**
     * Sets discoverable_disabled
     *
     * @param bool|null $discoverable_disabled discoverable_disabled
     *
     * @return $this
     */
    public function setDiscoverableDisabled(?bool $discoverable_disabled): static
    {
        if (is_null($discoverable_disabled)) {
            array_push($this->openAPINullablesSetToNull, 'discoverable_disabled');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('discoverable_disabled', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['discoverable_disabled'] = $discoverable_disabled;
    ...
    public function setGuildScheduledEventId(?string $guild_scheduled_event_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($guild_scheduled_event_id)))) {
            throw new InvalidArgumentException("invalid value for \$guild_scheduled_event_id when calling StageInstanceResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
