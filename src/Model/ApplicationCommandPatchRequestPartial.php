...
/**
 * ApplicationCommandPatchRequestPartial Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ApplicationCommandPatchRequestPartial implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ApplicationCommandPatchRequestPartial';
    ...
    */
    ...
    public function setName(?string $name): static
    {
        ...
        if ((mb_strlen($name) > 32)) {
            throw new InvalidArgumentException('invalid length for $name when calling ApplicationCommandPatchRequestPartial., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new InvalidArgumentException('invalid length for $name when calling ApplicationCommandPatchRequestPartial., must be bigger than or equal to 1.');
        }
    ...
    public function setNameLocalizations(?array&lt;string,string&gt; $name_localizations): static
    {
        ...
        if (!is_null($name_localizations) && (count($name_localizations) > 33)) {
            throw new InvalidArgumentException('invalid value for $name_localizations when calling ApplicationCommandPatchRequestPartial., number of items must be less than or equal to 33.');
        }
    ...
    public function setDescription(?string $description): static
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 100)) {
            throw new InvalidArgumentException('invalid length for $description when calling ApplicationCommandPatchRequestPartial., must be smaller than or equal to 100.');
        }
    ...
    public function setDescriptionLocalizations(?array&lt;string,string&gt; $description_localizations): static
    {
        ...
        if (!is_null($description_localizations) && (count($description_localizations) > 33)) {
            throw new InvalidArgumentException('invalid value for $description_localizations when calling ApplicationCommandPatchRequestPartial., number of items must be less than or equal to 33.');
        }
    ...
    public function setDefaultMemberPermissions(?int $default_member_permissions): static
    {
        ...
        if (!is_null($default_member_permissions) && ($default_member_permissions > 562949953421311)) {
            throw new InvalidArgumentException('invalid value for $default_member_permissions when calling ApplicationCommandPatchRequestPartial., must be smaller than or equal to 562949953421311.');
        }
        if (!is_null($default_member_permissions) && ($default_member_permissions < 0)) {
            throw new InvalidArgumentException('invalid value for $default_member_permissions when calling ApplicationCommandPatchRequestPartial., must be bigger than or equal to 0.');
        }
