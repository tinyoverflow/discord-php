...
/**
 * MessageMentionChannelResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MessageMentionChannelResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MessageMentionChannelResponse';
    ...
    */
    ...
    public function setId(string $id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($id)))) {
            throw new InvalidArgumentException("invalid value for \$id when calling MessageMentionChannelResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setGuildId(string $guild_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($guild_id)))) {
            throw new InvalidArgumentException("invalid value for \$guild_id when calling MessageMentionChannelResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
