...
/**
 * ApplicationCommandNumberOption Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ApplicationCommandNumberOption implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ApplicationCommandNumberOption';
    ...
    protected static array $openAPITypes = [
        ...
        'required' => 'bool',
        'autocomplete' => 'bool',
        'choices' => '\OpenAPI\Client\Model\ApplicationCommandOptionNumberChoice[]',
        'min_value' => 'float',
        'max_value' => 'float'
    ];
    ...
    */
    ...
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) > 32)) {
            throw new InvalidArgumentException('invalid length for $name when calling ApplicationCommandNumberOption., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new InvalidArgumentException('invalid length for $name when calling ApplicationCommandNumberOption., must be bigger than or equal to 1.');
        }
    ...
    public function setNameLocalizations(?array&lt;string,string&gt; $name_localizations): static
    {
        ...
        if (!is_null($name_localizations) && (count($name_localizations) > 33)) {
            throw new InvalidArgumentException('invalid value for $name_localizations when calling ApplicationCommandNumberOption., number of items must be less than or equal to 33.');
        }
    ...
    public function setDescription(string $description): static
    {
        ...
        if ((mb_strlen($description) > 100)) {
            throw new InvalidArgumentException('invalid length for $description when calling ApplicationCommandNumberOption., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new InvalidArgumentException('invalid length for $description when calling ApplicationCommandNumberOption., must be bigger than or equal to 1.');
        }
    ...
    public function setDescriptionLocalizations(?array&lt;string,string&gt; $description_localizations): static
    {
        ...
        if (!is_null($description_localizations) && (count($description_localizations) > 33)) {
            throw new InvalidArgumentException('invalid value for $description_localizations when calling ApplicationCommandNumberOption., number of items must be less than or equal to 33.');
        }
     ...
     * Gets choices
     *
     * @return \OpenAPI\Client\Model\ApplicationCommandOptionNumberChoice[]|null
     */
     ...
     * Sets choices
     *
     * @param \OpenAPI\Client\Model\ApplicationCommandOptionNumberChoice[]|null $choices choices
     *
     * @return $this
     */
