 ...
 */
class GithubUser implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GithubUser';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ((mb_strlen($this->container['login']) > 152133)) {
            $invalidProperties[] = "invalid value for 'login', the character length must be smaller than or equal to 152133.";
        }
        ...
        if ((mb_strlen($this->container['avatar_url']) > 2048)) {
    ...
    public function setLogin(string $login): static
    {
        ...
        if ((mb_strlen($login) > 152133)) {
            throw new InvalidArgumentException('invalid length for $login when calling GithubUser., must be smaller than or equal to 152133.');
        }
    ...
    public function setHtmlUrl(string $html_url): static
    {
        ...
        if ((mb_strlen($html_url) > 2048)) {
            throw new InvalidArgumentException('invalid length for $html_url when calling GithubUser., must be smaller than or equal to 2048.');
        }
    ...
    public function setAvatarUrl(string $avatar_url): static
    {
        ...
        if ((mb_strlen($avatar_url) > 2048)) {
            throw new InvalidArgumentException('invalid length for $avatar_url when calling GithubUser., must be smaller than or equal to 2048.');
        }
