...
/**
 * CreateThreadRequest Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateThreadRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'create_thread_request';
    ...
    protected static array $openAPITypes = [
        ...
        'applied_tags' => 'mixed',
        'message' => '\OpenAPI\Client\Model\BaseCreateMessageCreateRequest',
        'type' => 'OneOf',
        'invitable' => 'mixed'
    ];
    ...
    */
    ...
    public function setName(mixed $name): static
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 100)) {
            throw new InvalidArgumentException('invalid length for $name when calling CreateThreadRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new InvalidArgumentException('invalid length for $name when calling CreateThreadRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setRateLimitPerUser(mixed $rate_limit_per_user): static
    {
        ...
        if (!is_null($rate_limit_per_user) && ($rate_limit_per_user > 21600)) {
            throw new InvalidArgumentException('invalid value for $rate_limit_per_user when calling CreateThreadRequest., must be smaller than or equal to 21600.');
        }
        if (!is_null($rate_limit_per_user) && ($rate_limit_per_user < 0)) {
            throw new InvalidArgumentException('invalid value for $rate_limit_per_user when calling CreateThreadRequest., must be bigger than or equal to 0.');
        }
     ...
     * Gets message
     *
     * @return \OpenAPI\Client\Model\BaseCreateMessageCreateRequest
     */
    public function getMessage(): \OpenAPI\Client\Model\BaseCreateMessageCreateRequest
    {
     ...
     * Sets message
     *
     * @param \OpenAPI\Client\Model\BaseCreateMessageCreateRequest $message message
     *
     * @return $this
     */
    public function setMessage(\OpenAPI\Client\Model\BaseCreateMessageCreateRequest $message): static
    {
        if (is_null($message)) {
