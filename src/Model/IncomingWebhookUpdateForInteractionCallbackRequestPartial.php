...
/**
 * IncomingWebhookUpdateForInteractionCallbackRequestPartial Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class IncomingWebhookUpdateForInteractionCallbackRequestPartial implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'IncomingWebhookUpdateForInteractionCallbackRequestPartial';
    ...
    */
    ...
    public function setContent(?string $content): static
    {
        ...
        if (!is_null($content) && (mb_strlen($content) > 2000)) {
            throw new InvalidArgumentException('invalid length for $content when calling IncomingWebhookUpdateForInteractionCallbackRequestPartial., must be smaller than or equal to 2000.');
        }
