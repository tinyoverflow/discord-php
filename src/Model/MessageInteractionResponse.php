...
/**
 * MessageInteractionResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MessageInteractionResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MessageInteractionResponse';
    ...
    protected static array $openAPITypes = [
        'id' => 'string',
        'type' => '\OpenAPI\Client\Model\InteractionTypes',
        'name' => 'string',
    ...
    */
    ...
    public function setId(string $id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($id)))) {
            throw new InvalidArgumentException("invalid value for \$id when calling MessageInteractionResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\InteractionTypes
     */
    public function getType(): ?\OpenAPI\Client\Model\InteractionTypes
    {
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\InteractionTypes $type type
     *
     * @return $this
     */
    public function setType(?\OpenAPI\Client\Model\InteractionTypes $type): static
    {
        if (is_null($type)) {
