...
/**
 * IncomingWebhookInteractionRequest Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class IncomingWebhookInteractionRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'IncomingWebhookInteractionRequest';
    ...
    */
    ...
    public function setContent(?string $content): static
    {
        ...
        if (!is_null($content) && (mb_strlen($content) > 2000)) {
            throw new InvalidArgumentException('invalid length for $content when calling IncomingWebhookInteractionRequest., must be smaller than or equal to 2000.');
        }
