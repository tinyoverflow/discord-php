...
/**
 * PartialDiscordIntegrationResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PartialDiscordIntegrationResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PartialDiscordIntegrationResponse';
    ...
    */
    ...
    public function setId(string $id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($id)))) {
            throw new InvalidArgumentException("invalid value for \$id when calling PartialDiscordIntegrationResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setApplicationId(string $application_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($application_id)))) {
            throw new InvalidArgumentException("invalid value for \$application_id when calling PartialDiscordIntegrationResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
