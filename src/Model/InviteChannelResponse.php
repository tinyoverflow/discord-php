...
/**
 * InviteChannelResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class InviteChannelResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'InviteChannelResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'name' => 'string',
        'icon' => 'string',
        'recipients' => '\OpenAPI\Client\Model\InviteChannelRecipientResponse[]'
    ];
    ...
    */
    ...
    public function setId(string $id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($id)))) {
            throw new InvalidArgumentException("invalid value for \$id when calling InviteChannelResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
     ...
     * Gets recipients
     *
     * @return \OpenAPI\Client\Model\InviteChannelRecipientResponse[]|null
     */
     ...
     * Sets recipients
     *
     * @param \OpenAPI\Client\Model\InviteChannelRecipientResponse[]|null $recipients recipients
     *
     * @return $this
     */
