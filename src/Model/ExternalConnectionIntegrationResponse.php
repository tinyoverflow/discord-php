...
/**
 * ExternalConnectionIntegrationResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ExternalConnectionIntegrationResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ExternalConnectionIntegrationResponse';
    ...
    */
     ...
     * @return $this
     */
    public function setSubscriberCount(?int $subscriber_count): static
    {
    ...
    public function setRoleId(?string $role_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($role_id)))) {
            throw new InvalidArgumentException("invalid value for \$role_id when calling ExternalConnectionIntegrationResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
     ...
     * @return bool|null
     */
    public function getEnableEmoticons(): ?bool
    {
     ...
     *
     * @param bool|null $enable_emoticons enable_emoticons
     *
     * @return $this
     */
    public function setEnableEmoticons(?bool $enable_emoticons): static
    {
