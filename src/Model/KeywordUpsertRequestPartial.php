...
/**
 * KeywordUpsertRequestPartial Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class KeywordUpsertRequestPartial implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'KeywordUpsertRequestPartial';
    ...
    protected static array $openAPITypes = [
        ...
        'trigger_metadata' => '\OpenAPI\Client\Model\KeywordTriggerMetadata'
    ];
    ...
    */
    ...
    public function setName(?string $name): static
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new InvalidArgumentException('invalid length for $name when calling KeywordUpsertRequestPartial., must be smaller than or equal to 100.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\KeywordTriggerMetadata|null
     */
    public function getTriggerMetadata(): ?\OpenAPI\Client\Model\KeywordTriggerMetadata
    {
     ...
     *
     * @param \OpenAPI\Client\Model\KeywordTriggerMetadata|null $trigger_metadata trigger_metadata
     *
     * @return $this
     */
    public function setTriggerMetadata(?\OpenAPI\Client\Model\KeywordTriggerMetadata $trigger_metadata): static
    {
