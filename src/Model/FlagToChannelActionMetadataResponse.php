...
/**
 * FlagToChannelActionMetadataResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class FlagToChannelActionMetadataResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'FlagToChannelActionMetadataResponse';
    ...
    */
    ...
    public function setChannelId(string $channel_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($channel_id)))) {
            throw new InvalidArgumentException("invalid value for \$channel_id when calling FlagToChannelActionMetadataResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
