...
/**
 * ApplicationCommandOptionIntegerChoiceResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ApplicationCommandOptionIntegerChoiceResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ApplicationCommandOptionIntegerChoiceResponse';
    ...
    */
    ...
    public function setValue(int $value): static
    {
        ...
        if (($value > 9007199254740991)) {
            throw new InvalidArgumentException('invalid value for $value when calling ApplicationCommandOptionIntegerChoiceResponse., must be smaller than or equal to 9007199254740991.');
        }
        if (($value < -9007199254740991)) {
            throw new InvalidArgumentException('invalid value for $value when calling ApplicationCommandOptionIntegerChoiceResponse., must be bigger than or equal to -9007199254740991.');
        }
