...
/**
 * InviteStageInstanceResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class InviteStageInstanceResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'InviteStageInstanceResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'speaker_count' => 'int',
        'members' => '\OpenAPI\Client\Model\GuildMemberResponse[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('speaker_count', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['speaker_count'];
    }

    /**
     * Sets speaker_count
     *
     * @param int|null $speaker_count speaker_count
     *
     * @return $this
     */
    public function setSpeakerCount(?int $speaker_count): static
    {
        if (is_null($speaker_count)) {
            array_push($this->openAPINullablesSetToNull, 'speaker_count');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('speaker_count', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['speaker_count'] = $speaker_count;
     ...
     * Sets members
     *
     * @param \OpenAPI\Client\Model\GuildMemberResponse[]|null $members members
     *
     * @return $this
     */
