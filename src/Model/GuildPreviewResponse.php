...
/**
 * GuildPreviewResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GuildPreviewResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GuildPreviewResponse';
    ...
    protected static array $openAPINullables = [
		...
		'features' => false,
		'approximate_member_count' => false,
		'approximate_presence_count' => false,
		'emojis' => false,
		'stickers' => false
    ];
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['approximate_member_count'] === null) {
            $invalidProperties[] = "'approximate_member_count' can't be null";
        }
        if ($this->container['approximate_presence_count'] === null) {
            $invalidProperties[] = "'approximate_presence_count' can't be null";
        }
    ...
    public function setId(string $id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($id)))) {
            throw new InvalidArgumentException("invalid value for \$id when calling GuildPreviewResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
     ...
     *
     * @param int $approximate_member_count approximate_member_count
     *
     * @return $this
     */
    public function setApproximateMemberCount(int $approximate_member_count): static
    {
        if (is_null($approximate_member_count)) {
            throw new InvalidArgumentException('non-nullable approximate_member_count cannot be null');
        }
     ...
     *
     * @param int $approximate_presence_count approximate_presence_count
     *
     * @return $this
     */
    public function setApproximatePresenceCount(int $approximate_presence_count): static
    {
        if (is_null($approximate_presence_count)) {
            throw new InvalidArgumentException('non-nullable approximate_presence_count cannot be null');
        }
