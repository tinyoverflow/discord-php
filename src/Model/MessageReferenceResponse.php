...
/**
 * MessageReferenceResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MessageReferenceResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MessageReferenceResponse';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['message_id']) && !preg_match("/^(0|[1-9][0-9]*)$/", $this->container['message_id'])) {
    ...
    public function setChannelId(string $channel_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($channel_id)))) {
            throw new InvalidArgumentException("invalid value for \$channel_id when calling MessageReferenceResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setMessageId(?string $message_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($message_id)))) {
            throw new InvalidArgumentException("invalid value for \$message_id when calling MessageReferenceResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setGuildId(?string $guild_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($guild_id)))) {
            throw new InvalidArgumentException("invalid value for \$guild_id when calling MessageReferenceResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
