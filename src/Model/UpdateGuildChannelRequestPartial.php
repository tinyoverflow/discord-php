...
/**
 * UpdateGuildChannelRequestPartial Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateGuildChannelRequestPartial implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'UpdateGuildChannelRequestPartial';
    ...
    protected static array $openAPITypes = [
        ...
        'flags' => 'int',
        'available_tags' => '\OpenAPI\Client\Model\UpdateThreadTagRequest[]'
    ];
    ...
    */
    ...
    public function setName(?string $name): static
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new InvalidArgumentException('invalid length for $name when calling UpdateGuildChannelRequestPartial., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new InvalidArgumentException('invalid length for $name when calling UpdateGuildChannelRequestPartial., must be bigger than or equal to 1.');
        }
    ...
    public function setPosition(?int $position): static
    {
        ...
        if (!is_null($position) && ($position < 0)) {
            throw new InvalidArgumentException('invalid value for $position when calling UpdateGuildChannelRequestPartial., must be bigger than or equal to 0.');
        }
    ...
    public function setTopic(?string $topic): static
    {
        ...
        if (!is_null($topic) && (mb_strlen($topic) > 4096)) {
            throw new InvalidArgumentException('invalid length for $topic when calling UpdateGuildChannelRequestPartial., must be smaller than or equal to 4096.');
        }
        if (!is_null($topic) && (mb_strlen($topic) < 0)) {
            throw new InvalidArgumentException('invalid length for $topic when calling UpdateGuildChannelRequestPartial., must be bigger than or equal to 0.');
        }
    ...
    public function setBitrate(?int $bitrate): static
    {
        ...
        if (!is_null($bitrate) && ($bitrate < 8000)) {
            throw new InvalidArgumentException('invalid value for $bitrate when calling UpdateGuildChannelRequestPartial., must be bigger than or equal to 8000.');
        }
    ...
    public function setUserLimit(?int $user_limit): static
    {
        ...
        if (!is_null($user_limit) && ($user_limit < 0)) {
            throw new InvalidArgumentException('invalid value for $user_limit when calling UpdateGuildChannelRequestPartial., must be bigger than or equal to 0.');
        }
    ...
    public function setRateLimitPerUser(?int $rate_limit_per_user): static
    {
        ...
        if (!is_null($rate_limit_per_user) && ($rate_limit_per_user > 21600)) {
            throw new InvalidArgumentException('invalid value for $rate_limit_per_user when calling UpdateGuildChannelRequestPartial., must be smaller than or equal to 21600.');
        }
        if (!is_null($rate_limit_per_user) && ($rate_limit_per_user < 0)) {
            throw new InvalidArgumentException('invalid value for $rate_limit_per_user when calling UpdateGuildChannelRequestPartial., must be bigger than or equal to 0.');
        }
    ...
    public function setParentId(?string $parent_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($parent_id)))) {
            throw new InvalidArgumentException("invalid value for \$parent_id when calling UpdateGuildChannelRequestPartial., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setDefaultThreadRateLimitPerUser(?int $default_thread_rate_limit_per_user): static
    {
        ...
        if (!is_null($default_thread_rate_limit_per_user) && ($default_thread_rate_limit_per_user > 21600)) {
            throw new InvalidArgumentException('invalid value for $default_thread_rate_limit_per_user when calling UpdateGuildChannelRequestPartial., must be smaller than or equal to 21600.');
        }
        if (!is_null($default_thread_rate_limit_per_user) && ($default_thread_rate_limit_per_user < 0)) {
            throw new InvalidArgumentException('invalid value for $default_thread_rate_limit_per_user when calling UpdateGuildChannelRequestPartial., must be bigger than or equal to 0.');
        }
     ...
     * Gets available_tags
     *
     * @return \OpenAPI\Client\Model\UpdateThreadTagRequest[]|null
     */
     ...
     * Sets available_tags
     *
     * @param \OpenAPI\Client\Model\UpdateThreadTagRequest[]|null $available_tags available_tags
     *
     * @return $this
     */
