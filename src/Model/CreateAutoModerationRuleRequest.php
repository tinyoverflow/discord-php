...
/**
 * CreateAutoModerationRuleRequest Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateAutoModerationRuleRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'create_auto_moderation_rule_request';
    ...
    */
    ...
    public function setName(mixed $name): static
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 100)) {
            throw new InvalidArgumentException('invalid length for $name when calling CreateAutoModerationRuleRequest., must be smaller than or equal to 100.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\MentionSpamTriggerMetadata
     */
     ...
     *
     * @param \OpenAPI\Client\Model\MentionSpamTriggerMetadata $trigger_metadata trigger_metadata
     *
     * @return $this
     */
