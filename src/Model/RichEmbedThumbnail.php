...
/**
 * RichEmbedThumbnail Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class RichEmbedThumbnail implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RichEmbedThumbnail';
    ...
    */
    ...
    public function setUrl(?string $url): static
    {
        ...
        if (!is_null($url) && (mb_strlen($url) > 2048)) {
            throw new InvalidArgumentException('invalid length for $url when calling RichEmbedThumbnail., must be smaller than or equal to 2048.');
        }
    ...
    public function setPlaceholder(?string $placeholder): static
    {
        ...
        if (!is_null($placeholder) && (mb_strlen($placeholder) > 64)) {
            throw new InvalidArgumentException('invalid length for $placeholder when calling RichEmbedThumbnail., must be smaller than or equal to 64.');
        }
    ...
    public function setPlaceholderVersion(?int $placeholder_version): static
    {
        ...
        if (!is_null($placeholder_version) && ($placeholder_version > 2147483647)) {
            throw new InvalidArgumentException('invalid value for $placeholder_version when calling RichEmbedThumbnail., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($placeholder_version) && ($placeholder_version < 0)) {
            throw new InvalidArgumentException('invalid value for $placeholder_version when calling RichEmbedThumbnail., must be bigger than or equal to 0.');
        }
