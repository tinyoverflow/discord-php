...
/**
 * ApplicationCommandIntegerOption Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ApplicationCommandIntegerOption implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ApplicationCommandIntegerOption';
    ...
    protected static array $openAPITypes = [
        ...
        'required' => 'bool',
        'autocomplete' => 'bool',
        'choices' => '\OpenAPI\Client\Model\ApplicationCommandOptionIntegerChoice[]',
        'min_value' => 'int',
        'max_value' => 'int'
    ];
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['min_value']) && ($this->container['min_value'] > 9007199254740991)) {
            $invalidProperties[] = "invalid value for 'min_value', must be smaller than or equal to 9007199254740991.";
        }

        if (!is_null($this->container['min_value']) && ($this->container['min_value'] < -9007199254740991)) {
            $invalidProperties[] = "invalid value for 'min_value', must be bigger than or equal to -9007199254740991.";
        }

        if (!is_null($this->container['max_value']) && ($this->container['max_value'] > 9007199254740991)) {
            $invalidProperties[] = "invalid value for 'max_value', must be smaller than or equal to 9007199254740991.";
        }

        if (!is_null($this->container['max_value']) && ($this->container['max_value'] < -9007199254740991)) {
            $invalidProperties[] = "invalid value for 'max_value', must be bigger than or equal to -9007199254740991.";
        }
    ...
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) > 32)) {
            throw new InvalidArgumentException('invalid length for $name when calling ApplicationCommandIntegerOption., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new InvalidArgumentException('invalid length for $name when calling ApplicationCommandIntegerOption., must be bigger than or equal to 1.');
        }
    ...
    public function setNameLocalizations(?array&lt;string,string&gt; $name_localizations): static
    {
        ...
        if (!is_null($name_localizations) && (count($name_localizations) > 33)) {
            throw new InvalidArgumentException('invalid value for $name_localizations when calling ApplicationCommandIntegerOption., number of items must be less than or equal to 33.');
        }
    ...
    public function setDescription(string $description): static
    {
        ...
        if ((mb_strlen($description) > 100)) {
            throw new InvalidArgumentException('invalid length for $description when calling ApplicationCommandIntegerOption., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new InvalidArgumentException('invalid length for $description when calling ApplicationCommandIntegerOption., must be bigger than or equal to 1.');
        }
    ...
    public function setDescriptionLocalizations(?array&lt;string,string&gt; $description_localizations): static
    {
        ...
        if (!is_null($description_localizations) && (count($description_localizations) > 33)) {
            throw new InvalidArgumentException('invalid value for $description_localizations when calling ApplicationCommandIntegerOption., number of items must be less than or equal to 33.');
        }
     ...
     * Gets choices
     *
     * @return \OpenAPI\Client\Model\ApplicationCommandOptionIntegerChoice[]|null
     */
     ...
     * Sets choices
     *
     * @param \OpenAPI\Client\Model\ApplicationCommandOptionIntegerChoice[]|null $choices choices
     *
     * @return $this
     */
    ...
    public function setMinValue(?int $min_value): static
    {
        ...
        if (($min_value > 9007199254740991)) {
            throw new InvalidArgumentException('invalid value for $min_value when calling ApplicationCommandIntegerOption., must be smaller than or equal to 9007199254740991.');
        }
        if (($min_value < -9007199254740991)) {
            throw new InvalidArgumentException('invalid value for $min_value when calling ApplicationCommandIntegerOption., must be bigger than or equal to -9007199254740991.');
        }
    ...
    public function setMaxValue(?int $max_value): static
    {
        ...
        if (($max_value > 9007199254740991)) {
            throw new InvalidArgumentException('invalid value for $max_value when calling ApplicationCommandIntegerOption., must be smaller than or equal to 9007199254740991.');
        }
        if (($max_value < -9007199254740991)) {
            throw new InvalidArgumentException('invalid value for $max_value when calling ApplicationCommandIntegerOption., must be bigger than or equal to -9007199254740991.');
        }
