...
/**
 * UpdateGuildScheduledEventRequest Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateGuildScheduledEventRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'update_guild_scheduled_event_request';
    ...
    */
    ...
    public function setName(mixed $name): static
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 100)) {
            throw new InvalidArgumentException('invalid length for $name when calling UpdateGuildScheduledEventRequest., must be smaller than or equal to 100.');
        }
    ...
    public function setDescription(mixed $description): static
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1000)) {
            throw new InvalidArgumentException('invalid length for $description when calling UpdateGuildScheduledEventRequest., must be smaller than or equal to 1000.');
        }
     ...
     *
     * @param mixed|null $scheduled_start_time scheduled_start_time
     *
     * @return $this
     */
    ...
    public function setChannelId(mixed $channel_id): static
    {
        ...
        if (!is_null($channel_id) && (!preg_match("^(0|[1-9][0-9]*)$", ObjectSerializer::toString($channel_id)))) {
            throw new InvalidArgumentException("invalid value for \$channel_id when calling UpdateGuildScheduledEventRequest., must conform to the pattern ^(0|[1-9][0-9]*)$.");
        }
     ...
     *
     * @param mixed|null $entity_metadata entity_metadata
     *
     * @return $this
     */
