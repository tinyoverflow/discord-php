...
/**
 * GuildAuditLogResponseIntegrationsInner Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GuildAuditLogResponseIntegrationsInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GuildAuditLogResponse_integrations_inner';
    ...
    */
    ...
    public function setId(mixed $id): static
    {
        ...
        if (!is_null($id) && (!preg_match("^(0|[1-9][0-9]*)$", ObjectSerializer::toString($id)))) {
            throw new InvalidArgumentException("invalid value for \$id when calling GuildAuditLogResponseIntegrationsInner., must conform to the pattern ^(0|[1-9][0-9]*)$.");
        }
     ...
     * Sets application_id
     *
     * @param mixed $application_id application_id
     *
     * @return $this
     */
    public function setApplicationId(mixed $application_id): static
    {
        ...
        if (!is_null($application_id) && (!preg_match("^(0|[1-9][0-9]*)$", ObjectSerializer::toString($application_id)))) {
            throw new InvalidArgumentException("invalid value for \$application_id when calling GuildAuditLogResponseIntegrationsInner., must conform to the pattern ^(0|[1-9][0-9]*)$.");
        }
