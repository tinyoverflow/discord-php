...
/**
 * AddGuildMemberRequest Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AddGuildMemberRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'add_guild_member_request';
    ...
    protected static array $openAPITypes = [
        'nick' => 'string',
        'roles' => '\OpenAPI\Client\Model\UpdateSelfVoiceStateRequestChannelId[]',
        'mute' => 'bool',
        'deaf' => 'bool',
        'access_token' => 'string',
        'flags' => 'int'
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ((mb_strlen($this->container['access_token']) > 152133)) {
            $invalidProperties[] = "invalid value for 'access_token', the character length must be smaller than or equal to 152133.";
        }
    ...
    public function setNick(?string $nick): static
    {
        ...
        if (!is_null($nick) && (mb_strlen($nick) > 32)) {
            throw new InvalidArgumentException('invalid length for $nick when calling AddGuildMemberRequest., must be smaller than or equal to 32.');
        }
     ...
     * Sets roles
     *
     * @param \OpenAPI\Client\Model\UpdateSelfVoiceStateRequestChannelId[]|null $roles roles
     *
     * @return $this
     */
    ...
    public function setAccessToken(string $access_token): static
    {
        ...
        if ((mb_strlen($access_token) > 152133)) {
            throw new InvalidArgumentException('invalid length for $access_token when calling AddGuildMemberRequest., must be smaller than or equal to 152133.');
        }
