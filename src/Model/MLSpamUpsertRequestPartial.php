...
/**
 * MLSpamUpsertRequestPartial Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MLSpamUpsertRequestPartial implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MLSpamUpsertRequestPartial';
    ...
    */
    ...
    public function setName(?string $name): static
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new InvalidArgumentException('invalid length for $name when calling MLSpamUpsertRequestPartial., must be smaller than or equal to 100.');
        }
     ...
     *
     * @param object|null $trigger_metadata trigger_metadata
     *
     * @return $this
     */
