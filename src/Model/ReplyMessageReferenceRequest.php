...
/**
 * ReplyMessageReferenceRequest Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ReplyMessageReferenceRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ReplyMessageReferenceRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('fail_if_not_exists', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!preg_match("/^(0|[1-9][0-9]*)$/", $this->container['message_id'])) {
            $invalidProperties[] = "invalid value for 'message_id', must be conform to the pattern /^(0|[1-9][0-9]*)$/.";
        }
    ...
    public function setGuildId(?string $guild_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($guild_id)))) {
            throw new InvalidArgumentException("invalid value for \$guild_id when calling ReplyMessageReferenceRequest., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setChannelId(?string $channel_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($channel_id)))) {
            throw new InvalidArgumentException("invalid value for \$channel_id when calling ReplyMessageReferenceRequest., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setMessageId(string $message_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($message_id)))) {
            throw new InvalidArgumentException("invalid value for \$message_id when calling ReplyMessageReferenceRequest., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
     ...
     *
     * @param bool|null $fail_if_not_exists fail_if_not_exists
     *
     * @return $this
     */
    public function setFailIfNotExists(?bool $fail_if_not_exists): static
    {
        if (is_null($fail_if_not_exists)) {
            array_push($this->openAPINullablesSetToNull, 'fail_if_not_exists');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('fail_if_not_exists', $nullablesSetToNull);
            if ($index !== FALSE) {
