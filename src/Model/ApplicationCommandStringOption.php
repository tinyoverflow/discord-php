...
/**
 * ApplicationCommandStringOption Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ApplicationCommandStringOption implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ApplicationCommandStringOption';
    ...
    protected static array $openAPITypes = [
        ...
        'min_length' => 'int',
        'max_length' => 'int',
        'choices' => '\OpenAPI\Client\Model\ApplicationCommandOptionStringChoice[]'
    ];
    ...
    */
    ...
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) > 32)) {
            throw new InvalidArgumentException('invalid length for $name when calling ApplicationCommandStringOption., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new InvalidArgumentException('invalid length for $name when calling ApplicationCommandStringOption., must be bigger than or equal to 1.');
        }
    ...
    public function setNameLocalizations(?array&lt;string,string&gt; $name_localizations): static
    {
        ...
        if (!is_null($name_localizations) && (count($name_localizations) > 33)) {
            throw new InvalidArgumentException('invalid value for $name_localizations when calling ApplicationCommandStringOption., number of items must be less than or equal to 33.');
        }
    ...
    public function setDescription(string $description): static
    {
        ...
        if ((mb_strlen($description) > 100)) {
            throw new InvalidArgumentException('invalid length for $description when calling ApplicationCommandStringOption., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new InvalidArgumentException('invalid length for $description when calling ApplicationCommandStringOption., must be bigger than or equal to 1.');
        }
    ...
    public function setDescriptionLocalizations(?array&lt;string,string&gt; $description_localizations): static
    {
        ...
        if (!is_null($description_localizations) && (count($description_localizations) > 33)) {
            throw new InvalidArgumentException('invalid value for $description_localizations when calling ApplicationCommandStringOption., number of items must be less than or equal to 33.');
        }
    ...
    public function setMinLength(?int $min_length): static
    {
        ...
        if (!is_null($min_length) && ($min_length > 6000)) {
            throw new InvalidArgumentException('invalid value for $min_length when calling ApplicationCommandStringOption., must be smaller than or equal to 6000.');
        }
        if (!is_null($min_length) && ($min_length < 0)) {
            throw new InvalidArgumentException('invalid value for $min_length when calling ApplicationCommandStringOption., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxLength(?int $max_length): static
    {
        ...
        if (!is_null($max_length) && ($max_length > 6000)) {
            throw new InvalidArgumentException('invalid value for $max_length when calling ApplicationCommandStringOption., must be smaller than or equal to 6000.');
        }
        if (!is_null($max_length) && ($max_length < 1)) {
            throw new InvalidArgumentException('invalid value for $max_length when calling ApplicationCommandStringOption., must be bigger than or equal to 1.');
        }
     ...
     * Gets choices
     *
     * @return \OpenAPI\Client\Model\ApplicationCommandOptionStringChoice[]|null
     */
     ...
     * Sets choices
     *
     * @param \OpenAPI\Client\Model\ApplicationCommandOptionStringChoice[]|null $choices choices
     *
     * @return $this
     */
