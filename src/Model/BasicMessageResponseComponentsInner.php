...
/**
 * BasicMessageResponseComponentsInner Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class BasicMessageResponseComponentsInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BasicMessageResponse_components_inner';
    ...
    */
    ...
    public function setUrl(mixed $url): static
    {
        ...
        if (!is_null($url) && (mb_strlen($url) > 2048)) {
            throw new InvalidArgumentException('invalid length for $url when calling BasicMessageResponseComponentsInner., must be smaller than or equal to 2048.');
        }
