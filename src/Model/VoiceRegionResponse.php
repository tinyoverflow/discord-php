...
/**
 * VoiceRegionResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class VoiceRegionResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VoiceRegionResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('optimal', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['optimal'] === null) {
            $invalidProperties[] = "'optimal' can't be null";
        }
     ...
     * @return bool
     */
    public function getOptimal(): bool
    {
     ...
     * Sets optimal
     *
     * @param bool $optimal optimal
     *
     * @return $this
     */
    public function setOptimal(bool $optimal): static
    {
        if (is_null($optimal)) {
            throw new InvalidArgumentException('non-nullable optimal cannot be null');
        }
