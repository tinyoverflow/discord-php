...
class Button implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Button';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['custom_id']) && (mb_strlen($this->container['custom_id']) > 100)) {
    ...
    public function setCustomId(?string $custom_id): static
    {
        ...
        if (!is_null($custom_id) && (mb_strlen($custom_id) > 100)) {
            throw new InvalidArgumentException('invalid length for $custom_id when calling Button., must be smaller than or equal to 100.');
        }
    ...
    public function setLabel(?string $label): static
    {
        ...
        if (!is_null($label) && (mb_strlen($label) > 80)) {
            throw new InvalidArgumentException('invalid length for $label when calling Button., must be smaller than or equal to 80.');
        }
    ...
    public function setUrl(?string $url): static
    {
        ...
        if (!is_null($url) && (mb_strlen($url) > 512)) {
            throw new InvalidArgumentException('invalid length for $url when calling Button., must be smaller than or equal to 512.');
        }
