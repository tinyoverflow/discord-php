...
/**
 * MessageStickerItemResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MessageStickerItemResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MessageStickerItemResponse';
    ...
    */
    ...
    public function setId(string $id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($id)))) {
            throw new InvalidArgumentException("invalid value for \$id when calling MessageStickerItemResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
     ...
     * Gets format_type
     *
     * @return \OpenAPI\Client\Model\StickerFormatTypes
     */
     ...
     * Sets format_type
     *
     * @param \OpenAPI\Client\Model\StickerFormatTypes $format_type format_type
     *
     * @return $this
     */
