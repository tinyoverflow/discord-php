...
/**
 * GithubComment Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GithubComment implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GithubComment';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['commit_id']) && (mb_strlen($this->container['commit_id']) > 152133)) {
            $invalidProperties[] = "invalid value for 'commit_id', the character length must be smaller than or equal to 152133.";
        }

        if ($this->container['body'] === null) {
            $invalidProperties[] = "'body' can't be null";
        }
        if ((mb_strlen($this->container['body']) > 152133)) {
    ...
    public function setHtmlUrl(string $html_url): static
    {
        ...
        if ((mb_strlen($html_url) > 2048)) {
            throw new InvalidArgumentException('invalid length for $html_url when calling GithubComment., must be smaller than or equal to 2048.');
        }
    ...
    public function setCommitId(?string $commit_id): static
    {
        ...
        if (!is_null($commit_id) && (mb_strlen($commit_id) > 152133)) {
            throw new InvalidArgumentException('invalid length for $commit_id when calling GithubComment., must be smaller than or equal to 152133.');
        }
    ...
    public function setBody(string $body): static
    {
        ...
        if ((mb_strlen($body) > 152133)) {
            throw new InvalidArgumentException('invalid length for $body when calling GithubComment., must be smaller than or equal to 152133.');
        }
