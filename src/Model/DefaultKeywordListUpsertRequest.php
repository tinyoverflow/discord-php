...
/**
 * DefaultKeywordListUpsertRequest Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DefaultKeywordListUpsertRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DefaultKeywordListUpsertRequest';
    ...
    */
    ...
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new InvalidArgumentException('invalid length for $name when calling DefaultKeywordListUpsertRequest., must be smaller than or equal to 100.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\DefaultKeywordListTriggerMetadata
     */
     ...
     *
     * @param \OpenAPI\Client\Model\DefaultKeywordListTriggerMetadata $trigger_metadata trigger_metadata
     *
     * @return $this
     */
