...
/**
 * ApplicationCommandIntegerOptionResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ApplicationCommandIntegerOptionResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ApplicationCommandIntegerOptionResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'required' => 'bool',
        'autocomplete' => 'bool',
        'choices' => '\OpenAPI\Client\Model\ApplicationCommandOptionIntegerChoiceResponse[]',
        'min_value' => 'int',
        'max_value' => 'int'
    ];
    ...
    */
     ...
     * Gets choices
     *
     * @return \OpenAPI\Client\Model\ApplicationCommandOptionIntegerChoiceResponse[]|null
     */
     ...
     * Sets choices
     *
     * @param \OpenAPI\Client\Model\ApplicationCommandOptionIntegerChoiceResponse[]|null $choices choices
     *
     * @return $this
     */
    ...
    public function setMinValue(?int $min_value): static
    {
        ...
        if (($min_value > 9007199254740991)) {
            throw new InvalidArgumentException('invalid value for $min_value when calling ApplicationCommandIntegerOptionResponse., must be smaller than or equal to 9007199254740991.');
        }
        if (($min_value < -9007199254740991)) {
            throw new InvalidArgumentException('invalid value for $min_value when calling ApplicationCommandIntegerOptionResponse., must be bigger than or equal to -9007199254740991.');
        }
    ...
    public function setMaxValue(?int $max_value): static
    {
        ...
        if (($max_value > 9007199254740991)) {
            throw new InvalidArgumentException('invalid value for $max_value when calling ApplicationCommandIntegerOptionResponse., must be smaller than or equal to 9007199254740991.');
        }
        if (($max_value < -9007199254740991)) {
            throw new InvalidArgumentException('invalid value for $max_value when calling ApplicationCommandIntegerOptionResponse., must be bigger than or equal to -9007199254740991.');
        }
