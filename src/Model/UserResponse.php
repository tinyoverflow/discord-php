    ...
    */
    ...
    public function setId(string $id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($id)))) {
            throw new InvalidArgumentException("invalid value for \$id when calling UserResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setFlags(int $flags): static
    {
        ...
        if (($flags > 9007199254740991)) {
            throw new InvalidArgumentException('invalid value for $flags when calling UserResponse., must be smaller than or equal to 9007199254740991.');
        }
        if (($flags < -9007199254740991)) {
            throw new InvalidArgumentException('invalid value for $flags when calling UserResponse., must be bigger than or equal to -9007199254740991.');
        }
