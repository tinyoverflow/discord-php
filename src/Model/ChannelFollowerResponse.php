...
/**
 * ChannelFollowerResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ChannelFollowerResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ChannelFollowerResponse';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!preg_match("/^(0|[1-9][0-9]*)$/", $this->container['webhook_id'])) {
    ...
    public function setChannelId(string $channel_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($channel_id)))) {
            throw new InvalidArgumentException("invalid value for \$channel_id when calling ChannelFollowerResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setWebhookId(string $webhook_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($webhook_id)))) {
            throw new InvalidArgumentException("invalid value for \$webhook_id when calling ChannelFollowerResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
