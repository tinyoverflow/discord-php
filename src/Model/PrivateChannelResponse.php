...
/**
 * PrivateChannelResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PrivateChannelResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PrivateChannelResponse';
    ...
    */
    ...
    public function setId(string $id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($id)))) {
            throw new InvalidArgumentException("invalid value for \$id when calling PrivateChannelResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setLastMessageId(?string $last_message_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($last_message_id)))) {
            throw new InvalidArgumentException("invalid value for \$last_message_id when calling PrivateChannelResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
