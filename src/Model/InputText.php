 ...
 */
class InputText implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'InputText';
    ...
    */
    ...
    public function setCustomId(string $custom_id): static
    {
        ...
        if ((mb_strlen($custom_id) > 100)) {
            throw new InvalidArgumentException('invalid length for $custom_id when calling InputText., must be smaller than or equal to 100.');
        }
    ...
    public function setLabel(string $label): static
    {
        ...
        if ((mb_strlen($label) > 45)) {
            throw new InvalidArgumentException('invalid length for $label when calling InputText., must be smaller than or equal to 45.');
        }
    ...
    public function setValue(?string $value): static
    {
        ...
        if (!is_null($value) && (mb_strlen($value) > 4000)) {
            throw new InvalidArgumentException('invalid length for $value when calling InputText., must be smaller than or equal to 4000.');
        }
    ...
    public function setPlaceholder(?string $placeholder): static
    {
        ...
        if (!is_null($placeholder) && (mb_strlen($placeholder) > 100)) {
            throw new InvalidArgumentException('invalid length for $placeholder when calling InputText., must be smaller than or equal to 100.');
        }
    ...
    public function setMinLength(?int $min_length): static
    {
        ...
        if (!is_null($min_length) && ($min_length > 4000)) {
            throw new InvalidArgumentException('invalid value for $min_length when calling InputText., must be smaller than or equal to 4000.');
        }
        if (!is_null($min_length) && ($min_length < 0)) {
            throw new InvalidArgumentException('invalid value for $min_length when calling InputText., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxLength(?int $max_length): static
    {
        ...
        if (!is_null($max_length) && ($max_length > 4000)) {
            throw new InvalidArgumentException('invalid value for $max_length when calling InputText., must be smaller than or equal to 4000.');
        }
        if (!is_null($max_length) && ($max_length < 1)) {
            throw new InvalidArgumentException('invalid value for $max_length when calling InputText., must be bigger than or equal to 1.');
        }
