...
/**
 * ActionRowComponentsInner Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ActionRowComponentsInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ActionRow_components_inner';
    ...
    protected static array $openAPITypes = [
        ...
        'custom_id' => 'mixed',
        'style' => '\OpenAPI\Client\Model\TextStyleTypes',
        'label' => 'mixed',
        'disabled' => 'mixed',
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ((mb_strlen($this->container['label']) > 45)) {
            $invalidProperties[] = "invalid value for 'label', the character length must be smaller than or equal to 45.";
        }
        ...
        if (!is_null($this->container['min_length']) && ($this->container['min_length'] > 4000)) {
            $invalidProperties[] = "invalid value for 'min_length', must be smaller than or equal to 4000.";
        }
        ...
        if (!is_null($this->container['max_length']) && ($this->container['max_length'] > 4000)) {
            $invalidProperties[] = "invalid value for 'max_length', must be smaller than or equal to 4000.";
        }
    ...
    public function setCustomId(mixed $custom_id): static
    {
        ...
        if (!is_null($custom_id) && (mb_strlen($custom_id) > 100)) {
            throw new InvalidArgumentException('invalid length for $custom_id when calling ActionRowComponentsInner., must be smaller than or equal to 100.');
        }
     ...
     * Gets style
     *
     * @return \OpenAPI\Client\Model\TextStyleTypes
     */
    public function getStyle(): ?\OpenAPI\Client\Model\TextStyleTypes
    {
     ...
     * Sets style
     *
     * @param \OpenAPI\Client\Model\TextStyleTypes $style style
     *
     * @return $this
     */
    public function setStyle(?\OpenAPI\Client\Model\TextStyleTypes $style): static
    {
        if (is_null($style)) {
    ...
    public function setLabel(mixed $label): static
    {
        ...
        if (!is_null($label) && (mb_strlen($label) > 45)) {
            throw new InvalidArgumentException('invalid length for $label when calling ActionRowComponentsInner., must be smaller than or equal to 45.');
        }
    ...
    public function setUrl(mixed $url): static
    {
        ...
        if (!is_null($url) && (mb_strlen($url) > 512)) {
            throw new InvalidArgumentException('invalid length for $url when calling ActionRowComponentsInner., must be smaller than or equal to 512.');
        }
    ...
    public function setPlaceholder(mixed $placeholder): static
    {
        ...
        if (!is_null($placeholder) && (mb_strlen($placeholder) > 150)) {
            throw new InvalidArgumentException('invalid length for $placeholder when calling ActionRowComponentsInner., must be smaller than or equal to 150.');
        }
    ...
    public function setMinValues(mixed $min_values): static
    {
        ...
        if (!is_null($min_values) && ($min_values > 25)) {
            throw new InvalidArgumentException('invalid value for $min_values when calling ActionRowComponentsInner., must be smaller than or equal to 25.');
        }
        if (!is_null($min_values) && ($min_values < 0)) {
            throw new InvalidArgumentException('invalid value for $min_values when calling ActionRowComponentsInner., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxValues(mixed $max_values): static
    {
        ...
        if (!is_null($max_values) && ($max_values > 25)) {
            throw new InvalidArgumentException('invalid value for $max_values when calling ActionRowComponentsInner., must be smaller than or equal to 25.');
        }
        if (!is_null($max_values) && ($max_values < 1)) {
            throw new InvalidArgumentException('invalid value for $max_values when calling ActionRowComponentsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setValue(mixed $value): static
    {
        ...
        if (!is_null($value) && (mb_strlen($value) > 4000)) {
            throw new InvalidArgumentException('invalid length for $value when calling ActionRowComponentsInner., must be smaller than or equal to 4000.');
        }
    ...
    public function setMinLength(mixed $min_length): static
    {
        ...
        if (!is_null($min_length) && ($min_length > 4000)) {
            throw new InvalidArgumentException('invalid value for $min_length when calling ActionRowComponentsInner., must be smaller than or equal to 4000.');
        }
        if (!is_null($min_length) && ($min_length < 0)) {
            throw new InvalidArgumentException('invalid value for $min_length when calling ActionRowComponentsInner., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxLength(mixed $max_length): static
    {
        ...
        if (!is_null($max_length) && ($max_length > 4000)) {
            throw new InvalidArgumentException('invalid value for $max_length when calling ActionRowComponentsInner., must be smaller than or equal to 4000.');
        }
        if (!is_null($max_length) && ($max_length < 1)) {
            throw new InvalidArgumentException('invalid value for $max_length when calling ActionRowComponentsInner., must be bigger than or equal to 1.');
        }
