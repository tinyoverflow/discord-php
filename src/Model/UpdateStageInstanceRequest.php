...
/**
 * UpdateStageInstanceRequest Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateStageInstanceRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'update_stage_instance_request';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['topic']) && (mb_strlen($this->container['topic']) > 120)) {
    ...
    public function setTopic(?string $topic): static
    {
        ...
        if ((mb_strlen($topic) > 120)) {
            throw new InvalidArgumentException('invalid length for $topic when calling UpdateStageInstanceRequest., must be smaller than or equal to 120.');
        }
        if ((mb_strlen($topic) < 1)) {
            throw new InvalidArgumentException('invalid length for $topic when calling UpdateStageInstanceRequest., must be bigger than or equal to 1.');
        }
