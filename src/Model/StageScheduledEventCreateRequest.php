...
/**
 * StageScheduledEventCreateRequest Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class StageScheduledEventCreateRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'StageScheduledEventCreateRequest';
    ...
    */
    ...
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new InvalidArgumentException('invalid length for $name when calling StageScheduledEventCreateRequest., must be smaller than or equal to 100.');
        }
    ...
    public function setDescription(?string $description): static
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1000)) {
            throw new InvalidArgumentException('invalid length for $description when calling StageScheduledEventCreateRequest., must be smaller than or equal to 1000.');
        }
    ...
    public function setChannelId(?string $channel_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($channel_id)))) {
            throw new InvalidArgumentException("invalid value for \$channel_id when calling StageScheduledEventCreateRequest., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
