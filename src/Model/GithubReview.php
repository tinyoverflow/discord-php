...
/**
 * GithubReview Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GithubReview implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GithubReview';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ((mb_strlen($this->container['state']) > 152133)) {
            $invalidProperties[] = "invalid value for 'state', the character length must be smaller than or equal to 152133.";
        }
    ...
    public function setBody(?string $body): static
    {
        ...
        if (!is_null($body) && (mb_strlen($body) > 152133)) {
            throw new InvalidArgumentException('invalid length for $body when calling GithubReview., must be smaller than or equal to 152133.');
        }
    ...
    public function setHtmlUrl(string $html_url): static
    {
        ...
        if ((mb_strlen($html_url) > 2048)) {
            throw new InvalidArgumentException('invalid length for $html_url when calling GithubReview., must be smaller than or equal to 2048.');
        }
    ...
    public function setState(string $state): static
    {
        ...
        if ((mb_strlen($state) > 152133)) {
            throw new InvalidArgumentException('invalid length for $state when calling GithubReview., must be smaller than or equal to 152133.');
        }
