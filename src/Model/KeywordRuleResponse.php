...
/**
 * KeywordRuleResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class KeywordRuleResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'KeywordRuleResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'trigger_metadata' => '\OpenAPI\Client\Model\KeywordTriggerMetadataResponse'
    ];
    ...
    */
    ...
    public function setId(string $id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($id)))) {
            throw new InvalidArgumentException("invalid value for \$id when calling KeywordRuleResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setGuildId(string $guild_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($guild_id)))) {
            throw new InvalidArgumentException("invalid value for \$guild_id when calling KeywordRuleResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setCreatorId(string $creator_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($creator_id)))) {
            throw new InvalidArgumentException("invalid value for \$creator_id when calling KeywordRuleResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
     ...
     *
     * @return \OpenAPI\Client\Model\KeywordTriggerMetadataResponse
     */
    public function getTriggerMetadata(): \OpenAPI\Client\Model\KeywordTriggerMetadataResponse
    {
     ...
     *
     * @param \OpenAPI\Client\Model\KeywordTriggerMetadataResponse $trigger_metadata trigger_metadata
     *
     * @return $this
     */
    public function setTriggerMetadata(\OpenAPI\Client\Model\KeywordTriggerMetadataResponse $trigger_metadata): static
    {
