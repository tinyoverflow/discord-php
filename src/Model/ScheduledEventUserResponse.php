...
/**
 * ScheduledEventUserResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ScheduledEventUserResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ScheduledEventUserResponse';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['guild_scheduled_event_id'] === null) {
            $invalidProperties[] = "'guild_scheduled_event_id' can't be null";
        }
        if (!preg_match("/^(0|[1-9][0-9]*)$/", $this->container['guild_scheduled_event_id'])) {
     ...
     *
     * @param string $guild_scheduled_event_id guild_scheduled_event_id
     *
     * @return $this
     */
    public function setGuildScheduledEventId(string $guild_scheduled_event_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($guild_scheduled_event_id)))) {
            throw new InvalidArgumentException("invalid value for \$guild_scheduled_event_id when calling ScheduledEventUserResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setUserId(string $user_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($user_id)))) {
            throw new InvalidArgumentException("invalid value for \$user_id when calling ScheduledEventUserResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
