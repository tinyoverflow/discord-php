...
/**
 * ApplicationCommandSubcommandOptionOptionsInner Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ApplicationCommandSubcommandOptionOptionsInner implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ApplicationCommandSubcommandOption_options_inner';
    ...
    */
    ...
    public function setName(mixed $name): static
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 32)) {
            throw new InvalidArgumentException('invalid length for $name when calling ApplicationCommandSubcommandOptionOptionsInner., must be smaller than or equal to 32.');
        }
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new InvalidArgumentException('invalid length for $name when calling ApplicationCommandSubcommandOptionOptionsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setNameLocalizations(?array&lt;string,mixed&gt; $name_localizations): static
    {
        ...
        if (!is_null($name_localizations) && (count($name_localizations) > 33)) {
            throw new InvalidArgumentException('invalid value for $name_localizations when calling ApplicationCommandSubcommandOptionOptionsInner., number of items must be less than or equal to 33.');
        }
    ...
    public function setDescription(mixed $description): static
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 100)) {
            throw new InvalidArgumentException('invalid length for $description when calling ApplicationCommandSubcommandOptionOptionsInner., must be smaller than or equal to 100.');
        }
        if (!is_null($description) && (mb_strlen($description) < 1)) {
            throw new InvalidArgumentException('invalid length for $description when calling ApplicationCommandSubcommandOptionOptionsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setDescriptionLocalizations(?array&lt;string,mixed&gt; $description_localizations): static
    {
        ...
        if (!is_null($description_localizations) && (count($description_localizations) > 33)) {
            throw new InvalidArgumentException('invalid value for $description_localizations when calling ApplicationCommandSubcommandOptionOptionsInner., number of items must be less than or equal to 33.');
        }
    ...
    public function setMinLength(mixed $min_length): static
    {
        ...
        if (!is_null($min_length) && ($min_length > 6000)) {
            throw new InvalidArgumentException('invalid value for $min_length when calling ApplicationCommandSubcommandOptionOptionsInner., must be smaller than or equal to 6000.');
        }
        if (!is_null($min_length) && ($min_length < 0)) {
            throw new InvalidArgumentException('invalid value for $min_length when calling ApplicationCommandSubcommandOptionOptionsInner., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxLength(mixed $max_length): static
    {
        ...
        if (!is_null($max_length) && ($max_length > 6000)) {
            throw new InvalidArgumentException('invalid value for $max_length when calling ApplicationCommandSubcommandOptionOptionsInner., must be smaller than or equal to 6000.');
        }
        if (!is_null($max_length) && ($max_length < 1)) {
            throw new InvalidArgumentException('invalid value for $max_length when calling ApplicationCommandSubcommandOptionOptionsInner., must be bigger than or equal to 1.');
        }
