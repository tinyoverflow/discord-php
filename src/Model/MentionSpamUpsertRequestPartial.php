...
/**
 * MentionSpamUpsertRequestPartial Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MentionSpamUpsertRequestPartial implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MentionSpamUpsertRequestPartial';
    ...
    */
    ...
    public function setName(?string $name): static
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new InvalidArgumentException('invalid length for $name when calling MentionSpamUpsertRequestPartial., must be smaller than or equal to 100.');
        }
