...
/**
 * BotAccountPatchRequest Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class BotAccountPatchRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BotAccountPatchRequest';
    ...
    */
    ...
    public function setUsername(string $username): static
    {
        ...
        if ((mb_strlen($username) > 32)) {
            throw new InvalidArgumentException('invalid length for $username when calling BotAccountPatchRequest., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($username) < 2)) {
            throw new InvalidArgumentException('invalid length for $username when calling BotAccountPatchRequest., must be bigger than or equal to 2.');
        }
