...
/**
 * GuildProductPurchaseResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GuildProductPurchaseResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GuildProductPurchaseResponse';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!preg_match("/^(0|[1-9][0-9]*)$/", $this->container['listing_id'])) {
            $invalidProperties[] = "invalid value for 'listing_id', must be conform to the pattern /^(0|[1-9][0-9]*)$/.";
        }
    ...
    public function setListingId(string $listing_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($listing_id)))) {
            throw new InvalidArgumentException("invalid value for \$listing_id when calling GuildProductPurchaseResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
