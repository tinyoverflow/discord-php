...
/**
 * IntegrationApplicationResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class IntegrationApplicationResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'IntegrationApplicationResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'icon' => 'string',
        'description' => 'string',
        'type' => '\OpenAPI\Client\Model\BasicApplicationResponseType',
        'cover_image' => 'string',
        'primary_sku_id' => '\OpenAPI\Client\Model\UpdateSelfVoiceStateRequestChannelId',
        'bot' => '\OpenAPI\Client\Model\BasicApplicationResponseBot'
    ];
    ...
    */
    ...
    public function setId(string $id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($id)))) {
            throw new InvalidArgumentException("invalid value for \$id when calling IntegrationApplicationResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\BasicApplicationResponseType|null
     */
    public function getType(): ?\OpenAPI\Client\Model\BasicApplicationResponseType
    {
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\BasicApplicationResponseType|null $type type
     *
     * @return $this
     */
    public function setType(?\OpenAPI\Client\Model\BasicApplicationResponseType $type): static
    {
        if (is_null($type)) {
     ...
     * Gets bot
     *
     * @return \OpenAPI\Client\Model\BasicApplicationResponseBot|null
     */
    public function getBot(): ?\OpenAPI\Client\Model\BasicApplicationResponseBot
    {
     ...
     * Sets bot
     *
     * @param \OpenAPI\Client\Model\BasicApplicationResponseBot|null $bot bot
     *
     * @return $this
     */
    public function setBot(?\OpenAPI\Client\Model\BasicApplicationResponseBot $bot): static
    {
        if (is_null($bot)) {
