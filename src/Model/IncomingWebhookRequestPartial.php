...
/**
 * IncomingWebhookRequestPartial Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class IncomingWebhookRequestPartial implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'IncomingWebhookRequestPartial';
    ...
    */
    ...
    public function setContent(?string $content): static
    {
        ...
        if (!is_null($content) && (mb_strlen($content) > 2000)) {
            throw new InvalidArgumentException('invalid length for $content when calling IncomingWebhookRequestPartial., must be smaller than or equal to 2000.');
        }
    ...
    public function setUsername(?string $username): static
    {
        ...
        if (!is_null($username) && (mb_strlen($username) > 80)) {
            throw new InvalidArgumentException('invalid length for $username when calling IncomingWebhookRequestPartial., must be smaller than or equal to 80.');
        }
        if (!is_null($username) && (mb_strlen($username) < 1)) {
            throw new InvalidArgumentException('invalid length for $username when calling IncomingWebhookRequestPartial., must be bigger than or equal to 1.');
        }
    ...
    public function setAvatarUrl(?string $avatar_url): static
    {
        ...
        if (!is_null($avatar_url) && (mb_strlen($avatar_url) > 2048)) {
            throw new InvalidArgumentException('invalid length for $avatar_url when calling IncomingWebhookRequestPartial., must be smaller than or equal to 2048.');
        }
     ...
     * Sets thread_name
     *
     * @param string|null $thread_name thread_name
     *
     * @return $this
     */
    public function setThreadName(?string $thread_name): static
    {
        ...
        if (!is_null($thread_name) && (mb_strlen($thread_name) > 100)) {
            throw new InvalidArgumentException('invalid length for $thread_name when calling IncomingWebhookRequestPartial., must be smaller than or equal to 100.');
        }
        if (!is_null($thread_name) && (mb_strlen($thread_name) < 0)) {
            throw new InvalidArgumentException('invalid length for $thread_name when calling IncomingWebhookRequestPartial., must be bigger than or equal to 0.');
        }
