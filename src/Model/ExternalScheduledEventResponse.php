...
/**
 * ExternalScheduledEventResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ExternalScheduledEventResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ExternalScheduledEventResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'auto_start' => 'bool',
        'entity_metadata' => '\OpenAPI\Client\Model\EntityMetadataExternalResponse'
    ];
    ...
    */
    ...
    public function setId(string $id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($id)))) {
            throw new InvalidArgumentException("invalid value for \$id when calling ExternalScheduledEventResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setGuildId(string $guild_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($guild_id)))) {
            throw new InvalidArgumentException("invalid value for \$guild_id when calling ExternalScheduledEventResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setChannelId(?string $channel_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($channel_id)))) {
            throw new InvalidArgumentException("invalid value for \$channel_id when calling ExternalScheduledEventResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setCreatorId(?string $creator_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($creator_id)))) {
            throw new InvalidArgumentException("invalid value for \$creator_id when calling ExternalScheduledEventResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setEntityId(?string $entity_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($entity_id)))) {
            throw new InvalidArgumentException("invalid value for \$entity_id when calling ExternalScheduledEventResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
     ...
     *
     * @return \OpenAPI\Client\Model\EntityMetadataExternalResponse
     */
    public function getEntityMetadata(): \OpenAPI\Client\Model\EntityMetadataExternalResponse
    {
     ...
     *
     * @param \OpenAPI\Client\Model\EntityMetadataExternalResponse $entity_metadata entity_metadata
     *
     * @return $this
     */
    public function setEntityMetadata(\OpenAPI\Client\Model\EntityMetadataExternalResponse $entity_metadata): static
    {
