...
class CreateWebhookRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'create_webhook_request';
    ...
    */
    ...
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) > 80)) {
            throw new InvalidArgumentException('invalid length for $name when calling CreateWebhookRequest., must be smaller than or equal to 80.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new InvalidArgumentException('invalid length for $name when calling CreateWebhookRequest., must be bigger than or equal to 1.');
        }
