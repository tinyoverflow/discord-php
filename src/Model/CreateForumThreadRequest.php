...
/**
 * CreateForumThreadRequest Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateForumThreadRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CreateForumThreadRequest';
    ...
    */
    ...
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new InvalidArgumentException('invalid length for $name when calling CreateForumThreadRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new InvalidArgumentException('invalid length for $name when calling CreateForumThreadRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setRateLimitPerUser(?int $rate_limit_per_user): static
    {
        ...
        if (!is_null($rate_limit_per_user) && ($rate_limit_per_user > 21600)) {
            throw new InvalidArgumentException('invalid value for $rate_limit_per_user when calling CreateForumThreadRequest., must be smaller than or equal to 21600.');
        }
        if (!is_null($rate_limit_per_user) && ($rate_limit_per_user < 0)) {
            throw new InvalidArgumentException('invalid value for $rate_limit_per_user when calling CreateForumThreadRequest., must be bigger than or equal to 0.');
        }
