 ...
 */
class RoleSelect implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RoleSelect';
    ...
    protected static array $openAPITypes = [
        ...
        'max_values' => 'int',
        'disabled' => 'bool',
        'default_values' => '\OpenAPI\Client\Model\RoleSelectDefaultValue[]'
    ];
    ...
    */
    ...
    public function setCustomId(string $custom_id): static
    {
        ...
        if ((mb_strlen($custom_id) > 100)) {
            throw new InvalidArgumentException('invalid length for $custom_id when calling RoleSelect., must be smaller than or equal to 100.');
        }
    ...
    public function setPlaceholder(?string $placeholder): static
    {
        ...
        if (!is_null($placeholder) && (mb_strlen($placeholder) > 150)) {
            throw new InvalidArgumentException('invalid length for $placeholder when calling RoleSelect., must be smaller than or equal to 150.');
        }
    ...
    public function setMinValues(?int $min_values): static
    {
        ...
        if (!is_null($min_values) && ($min_values > 25)) {
            throw new InvalidArgumentException('invalid value for $min_values when calling RoleSelect., must be smaller than or equal to 25.');
        }
        if (!is_null($min_values) && ($min_values < 0)) {
            throw new InvalidArgumentException('invalid value for $min_values when calling RoleSelect., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxValues(?int $max_values): static
    {
        ...
        if (!is_null($max_values) && ($max_values > 25)) {
            throw new InvalidArgumentException('invalid value for $max_values when calling RoleSelect., must be smaller than or equal to 25.');
        }
        if (!is_null($max_values) && ($max_values < 1)) {
            throw new InvalidArgumentException('invalid value for $max_values when calling RoleSelect., must be bigger than or equal to 1.');
        }
     ...
     * Gets default_values
     *
     * @return \OpenAPI\Client\Model\RoleSelectDefaultValue[]|null
     */
     ...
     * Sets default_values
     *
     * @param \OpenAPI\Client\Model\RoleSelectDefaultValue[]|null $default_values default_values
     *
     * @return $this
     */
