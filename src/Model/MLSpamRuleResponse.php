...
/**
 * MLSpamRuleResponse Class Doc Comment
 *
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class MLSpamRuleResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MLSpamRuleResponse';
    ...
    */
    ...
    public function setId(string $id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($id)))) {
            throw new InvalidArgumentException("invalid value for \$id when calling MLSpamRuleResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setGuildId(string $guild_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($guild_id)))) {
            throw new InvalidArgumentException("invalid value for \$guild_id when calling MLSpamRuleResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
    ...
    public function setCreatorId(string $creator_id): static
    {
        ...
        if ((!preg_match("/^(0|[1-9][0-9]*)$/", ObjectSerializer::toString($creator_id)))) {
            throw new InvalidArgumentException("invalid value for \$creator_id when calling MLSpamRuleResponse., must conform to the pattern /^(0|[1-9][0-9]*)$/.");
        }
